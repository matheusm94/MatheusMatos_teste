...
public class CadastroMotorista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Motorista m = new Motorista(request.getParameter("nome"),request.getParameter("cpf"), request.getParameter("modeloCarro"), (Integer.parseInt(request.getParameter("idade"))), request.getParameter("sexo"), request.getParameter("status"));
            ...
            try {
                ...
                if (retorno > 0) {
                    response.sendRedirect("CadastroMotorista.jsp?status=1a");
                } else {
                    response.sendRedirect("CadastroMotorista.jsp?status=1b");
                }
